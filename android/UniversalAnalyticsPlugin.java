...
public class UniversalAnalyticsPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        } else if (ENABLE_ADS.equals(action)) {
            this.enableAds(callbackContext);
        }
        return false;
    }
    ...
    private void enableAds (CallbackContext callbackContext) {
        try {
            tracker.enableAdvertisingIdCollection(true);
            callbackContext.success();
        } catch (Exception e){
            callbackContext.error("There is no enableAdvertisingIdCollection method");
        }
